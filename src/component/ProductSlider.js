...
const ProductSlider = () => {
  ...
  🙂`,delevry:true,quant:4,sale:false,saleValu:0},{title:'JE01 001',proTyp:'بنطلون',proId:1,price:100,imgs:['https://react-product-card.vercel.app/static/media/black.f49f54e4.png','https://imgur.com/VcypK5c.png'],colors:[],des:`مش سهل انك تلاقي البنطلون اللي بيجمع
  ما بين التصميم المميز و الجودة العالية و السعر المنافس
  و لكن في F16 Online حققنا المعادلة الصعبه
